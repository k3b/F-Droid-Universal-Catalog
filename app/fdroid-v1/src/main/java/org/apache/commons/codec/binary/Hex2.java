...
/**
 * copied from org.apache.commons.codec.binary.Hex.java which is not compatible with my android-4.2
 * <p>
 ...
 * @since 1.1
 */
public class Hex2 implements BinaryEncoder, BinaryDecoder {
     ...
     * @since 1.7
     */
    public Hex2(final Charset charset) {
     ...
     */
    public Hex2(final String charsetName) {
