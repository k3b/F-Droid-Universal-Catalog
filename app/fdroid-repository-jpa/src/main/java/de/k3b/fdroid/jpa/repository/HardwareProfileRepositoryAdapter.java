 ...
 */
@Service
public class HardwareProfileRepositoryAdapter extends RepositoryAdapterBase<Integer, HardwareProfile, HardwareProfileRepositoryJpa> implements HardwareProfileRepository {
    public HardwareProfileRepositoryAdapter(HardwareProfileRepositoryJpa jpa) {
        super(jpa);
    }

    @Override
    public HardwareProfile findByName(String name) {
