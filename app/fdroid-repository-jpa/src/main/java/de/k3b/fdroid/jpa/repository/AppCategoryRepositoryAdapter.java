 ...
 */
@Service
public class AppCategoryRepositoryAdapter extends RepositoryAdapterBase<Integer, AppCategory, AppCategoryRepositoryJpa> implements AppCategoryRepository {
    public AppCategoryRepositoryAdapter(AppCategoryRepositoryJpa jpa) {
        super(jpa);
    }

    @Override
    public List<AppCategory> findByAppId(int appId) {
