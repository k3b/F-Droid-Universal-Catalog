 ...
 */
@Service
public class AppAntiFeatureRepositoryAdapter extends RepositoryAdapterBase<Integer, AppAntiFeature, AppAntiFeatureRepositoryJpa> implements AppAntiFeatureRepository {
    public AppAntiFeatureRepositoryAdapter(AppAntiFeatureRepositoryJpa jpa) {
        super(jpa);
    }

    @Override
    public List<AppAntiFeature> findByAppId(int appId) {
