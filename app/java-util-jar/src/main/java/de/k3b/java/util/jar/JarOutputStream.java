...
public class JarOutputStream extends ZipOutputStream {
     ...
     * @param mf the {@code Manifest} to output for this JAR file.
     * @throws IOException if an error occurs creating the {@code JarOutputStream}.
     */
     ...
     *
     * @param ze the {@code ZipEntry} to write to.
     * @throws IOException if an error occurs writing to the entry.
     * @see ZipEntry
     */
    @Override
