...
public abstract class Pack200 {
    private static final String SYSTEM_PROPERTY_PACKER = "de.k3b.java.util.jar.Pack200.Packer";
    private static final String SYSTEM_PROPERTY_UNPACKER = "de.k3b.java.util.jar.Pack200.Unpacker";
     ...
     * {@code 'de.k3b.java.util.jar.Pack200.Packer'}. If this system property is
     ...
     * property {@code 'de.k3b.java.util.jar.Pack200.Unpacker'}. If this system
    ...
    public interface Unpacker {
         ...
         *
         * @param listener the listener to listen if {@code PropertyChange} events
         *                 occurs.
         */
        void addPropertyChangeListener(PropertyChangeListener listener);
