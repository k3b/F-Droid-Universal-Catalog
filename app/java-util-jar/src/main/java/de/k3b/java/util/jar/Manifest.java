...
import de.k3b.org.apache.harmony.util.InputStreamHelper;
...
public class Manifest implements Cloneable {
     ...
     *
     * @param man {@code Manifest} instance to obtain attributes from.
     */
     ...
     * {@code name}.
     *
     * @param name the name of the entry to obtain {@code Attributes} from.
