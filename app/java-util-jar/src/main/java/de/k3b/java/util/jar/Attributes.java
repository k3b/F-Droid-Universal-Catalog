...
import de.k3b.org.apache.harmony.util.Util;
...
public class Attributes implements Cloneable, Map<Object, Object> {
     ...
     *
     * @param attrib The attributes to obtain entries from.
     */
     ...
     * {@code size}.
     *
     * @param size Initial size of this {@code Attributes} instance.
     */
     ...
     * @param value the value to store in this {@code Attributes}.
     * @return the value being stored.
     * @throws ClassCastException when key is not an {@code Attributes.Name} or value is not
     *                            a {@code String}.
     */
     ...
     * Attributes}.
     *
     * @param attrib the associations to store (must be of type {@code
     *               Attributes}).
     */
     ...
     *
     * @param obj the object with which this {@code Attributes} is compared.
     ...
     * key.
     *
     * @param name the key to obtain the value for.
     ...
     * @param val  the value to store in this {@code Attributes}.
     * @return the value being stored.
     */
    ...
    public static class Name {
         ...
         * @throws IllegalArgumentException if the string does not satisfy the EBNF grammar.
         */
         ...
         * name.
         *
         * @param object An attribute name to be compared with this name.
