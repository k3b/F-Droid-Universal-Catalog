...
public class CommonFacadeTest {
    ...
    private static final LocalizedCommonFacade LOCALIZED_COMMON_FACADE_FILLED
            = new LocalizedCommonFacade(LOCALIZED_COMMON_FILLED);
    ...
    private static final LocalizedAppFacade LOCALIZEDAPP_COMMON_FACADE_FILLED
            = new LocalizedAppFacade(null, LOCALIZED_COMMON_FILLED);
    private static final LocalizedAppFacade LOCALIZEDAPP_COMMON_FACADE_EMPTY
            = new LocalizedAppFacade(null, LOCALIZED_COMMON_EMPTY);
    ...
    private Object[] getExamples() {
        return new Object[]{
                ...
                new Object[]{"LOCALIZEDAPP_COMMON_FACADE_EMPTY", LOCALIZED_COMMON_EMPTY, LOCALIZEDAPP_COMMON_FACADE_EMPTY},

                // Icon is included in toString() twice because icon is part of app and of localized
                // new Object[]{"LOCALIZEDAPP_COMMON_FACADE_FILLED", LOCALIZED_COMMON_FILLED, LOCALIZEDAPP_COMMON_FACADE_FILLED},
    ...
    public void localized(String comment, Object commonExpected, Object facadeActual) {
        assertEquals(comment, toString(commonExpected), toString(facadeActual));
    }

    private String toString(Object o) {
        return o.toString()
                .replace("Facade", "")
                .replace("LocalizedApp[", "LocalizedCommon[");
    }
}
